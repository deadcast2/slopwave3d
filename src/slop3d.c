...
static inline S3D_Mat4 m4_perspective(float fov_deg, float aspect,
...
static inline S3D_Mat4 m4_lookat(S3D_Vec3 eye, S3D_Vec3 target,
                                  S3D_Vec3 up) {
...
static void update_camera(void) {
    ...
    cam->projection = m4_perspective(cam->fov, aspect,
...
EMSCRIPTEN_KEEPALIVE
void s3d_camera_set(float px, float py, float pz,
